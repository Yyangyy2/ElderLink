...
public class ProfilePageElder_ElderSide extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(v -> {
            Intent intent = new Intent(ProfilePageElder_ElderSide.this, MainActivityElder.class);
    ...
    private void saveProfile() {
        ...
        elderRef.update(
            ...
            Toast.makeText(ProfilePageElder_ElderSide.this, "Profile saved successfully!", Toast.LENGTH_SHORT).show();

        }).addOnFailureListener(e ->
                Toast.makeText(ProfilePageElder_ElderSide.this, "Failed to save profile: " + e.getMessage(), Toast.LENGTH_SHORT).show()
        );
    }
