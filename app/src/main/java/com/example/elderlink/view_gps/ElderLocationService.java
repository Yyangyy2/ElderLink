...
//    private static boolean isRunning = false; // Track if service is running
//
...
//
//
//        // If service is already running, stop it first
//        if (isRunning) {
//            Log.d("ElderLocationService", "Service already running, stopping previous instance");
//            stopSelf();
//        }
//
//
...
//        return START_STICKY;        // Don't restart automatically
//    }
//
